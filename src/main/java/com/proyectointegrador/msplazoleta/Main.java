...
public class Main {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("OK: Restaurante creado - " + r.getNombre());
        ...
        try {
            ...
            System.out.println("OK: Plato creado - " + p.getNombre() + " - Activo: " + p.isActivo());
        } catch (Exception e) { System.out.println("ERROR: " + e.getMessage()); }

        try {
            Plato p = ps.modificarPlato(1L, 20000, "Arroz, frijoles, carne, chicharrón, huevo, aguacate", 1L);
            System.out.println("OK: Plato modificado - $" + p.getPrecio());
        } catch (Exception e) { System.out.println("ERROR: " + e.getMessage()); }
    }
}